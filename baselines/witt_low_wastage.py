...
def main_witt_wastage(workflow: str, seed: int, error_metric: str, alpha: float, use_softmax: bool, batch_size: int, retrain_interval: int):
    """
                    ...
                    for use_softmax_single in use_softmax:
                        ...
                        for task in unique_tasks:
                            ...
                            if check_substring_in_csv(workflow, alpha, use_softmax_single, error_metric, "Witt-Ice", task,
                                                   "Default",
                                                   "Default", seed, batch_size, retrain_interval):
                                continue
                            ...
                            write_result_to_csv("Witt-Ice", "Default", "Default", task, w.wastage_GB, w.wastage_GBh,
                                                w.failures, w.runtime_h, "1", workflow, time_needed, "1.0", alpha, use_softmax_single, {}, error_metric, "-1", seed, batch_size, retrain_interval=0)
